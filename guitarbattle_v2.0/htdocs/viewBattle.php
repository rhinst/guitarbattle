...
<? } ?>
  <tr>
    <td colspan="3" align="center">
      <br><br>
<?
  if(($battle_active == "1") && ($battle_user2 != '') && (!user_already_voted($authenticated_user, $battle_id)) && ($authenticated_user != $battle_user1) && ($authenticated_user != $battle_user2) && ($authenticated_user != $battle_collab1) && ($authenticated_user != $battle_collab2)) {
    ...
    $totalVotes = count($voteResults) / $numParticipants;
	...
	else if($vote_competitor == $battle_user2) {
